...
import com.enjaz.hr.databinding.FragmentSecondOnboardingBinding
...
@AndroidEntryPoint
class OnboardingSecFragment :
    BaseFragment<FragmentSecondOnboardingBinding, IOnboardingInteractionListener, OnboardingViewModel>(),
