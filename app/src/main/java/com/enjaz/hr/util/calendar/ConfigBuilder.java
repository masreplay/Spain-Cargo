...
public class ConfigBuilder {
    ...
    public ConfigBuilder unselectedDateBackground(Drawable background) {
        this.unselectedItemBackground = background;
        return this;
    }
    ...
    CalendarItemStyle createDefaultStyle() {
        return new CalendarItemStyle(colorTextTop, colorTextMiddle, colorTextBottom, unselectedItemBackground);
    }
