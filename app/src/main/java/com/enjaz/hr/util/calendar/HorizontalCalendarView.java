package com.enjaz.hr.util.calendar;
...
import com.enjaz.hr.util.calendar.adapter.HorizontalCalendarBaseAdapter;
import com.enjaz.hr.util.calendar.model.CalendarItemStyle;
import com.enjaz.hr.util.calendar.model.HorizontalCalendarConfig;
...
public class HorizontalCalendarView extends RecyclerView {
    ...
    public HorizontalCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            Drawable unSelectedDateBackground = a.getDrawable(R.styleable.HorizontalCalendarView_unSelectedDateBackground);
            ...
            defaultStyle = new CalendarItemStyle(colorTopText, colorMiddleText, colorBottomText, unSelectedDateBackground);
